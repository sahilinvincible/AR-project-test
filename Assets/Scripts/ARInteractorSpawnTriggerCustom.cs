...
/// </summary>
public class ARInteractorSpawnTriggerCustom : MonoBehaviour
{
    /// <summary>
    ...
    [SerializeField]
    //[RequiredInterface(typeof(IARInteractor))]
    ...
    ObjectSpawnerCustom m_ObjectSpawner;

    /// <summary>
    /// The behavior to use to spawn objects.
    /// </summary>
    public ObjectSpawnerCustom objectSpawner
    {
        get => m_ObjectSpawner;
...
#else
            m_ObjectSpawner = FindObjectOfType<ObjectSpawnerCustom>();
#endif
